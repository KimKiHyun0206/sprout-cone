...
public class SignInService {
    ...
    public String signIn(String code) {
        ...
        runnerJapRepository.save(runner);       // 3. Runner 저장 (UPDATE 쿼리 발생)
